...
class SystemFontScanner {
  static const List<String> _systemFontExtensions = ['.ttf', '.otf', '.ttc'];
  ...
  static Future<List<SystemFontInfo>> scanSystemFonts() async {
    ...
    // 添加默认字体
    fonts.insert(0, const SystemFontInfo(name: '系统默认', path: '', family: ''));

    // 去重
    final uniqueFonts = fonts.fold<List<SystemFontInfo>>([], (
      previous,
      element,
    ) {
